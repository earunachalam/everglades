...
int main(int argc, char* argv[])
{
	...
	uint Nx1 = std::stod(params.find("Nx1")->second);		// number of grid elements along direction 1, in system (natural) units
	uint Nx2 = std::stod(params.find("Nx2")->second);		// number of grid elements along direction 1, in system (natural) units
